...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Ribix warn -> off
			...
			// Ribix - this should only apply to workbench/void/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Ribix
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Ribix
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Ribix
		}
	},
	// vscode TS
	{
