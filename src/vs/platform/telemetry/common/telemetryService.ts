...
Ribix separately records basic usage like the number of messages people are sending. If you'd like to disable Ribix metrics, you may do so in Ribix's Settings.
`;
