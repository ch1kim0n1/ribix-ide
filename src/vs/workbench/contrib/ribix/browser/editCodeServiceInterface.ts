...
import { Diff, DiffArea, RibixFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getRibixFileSnapshot(uri: URI): RibixFileSnapshot;
	restoreRibixFileSnapshot(uri: URI, snapshot: RibixFileSnapshot): void;
}
