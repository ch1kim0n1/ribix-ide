...
import { VOID_TOGGLE_SETTINGS_ACTION_ID } from './ribixSettingsPane.js';
...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_OPEN_SIDEBAR_ACTION_ID, title: localize2('voidOpenSidebar', 'Ribix IDE: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidCmdL', 'Ribix IDE: Add Selection to Chat'),
			keybinding: {
