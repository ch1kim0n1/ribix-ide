...
export const displayInfoOfProviderName = (providerName: ProviderName): DisplayInfoForProviderName => {
	...
	else if (providerName === 'ribix') {
		return { title: 'Ribix AI', desc: 'Access curated models via your Ribix paid plan — no API key required.' }
	}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with Ribix IDE. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
	...
	if (providerName === 'ribix') return 'Sign in via **Settings → Ribix Command Center** to activate these models. Requires a Pro or Team plan.'
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	...
	ribix: {
		...defaultCustomSettings,
		...defaultProviderSettings.ribix,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.ribix),
		_didFillInProviderSettings: undefined,
	},
}
