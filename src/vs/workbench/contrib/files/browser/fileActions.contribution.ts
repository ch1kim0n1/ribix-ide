...
import { VOID_OPEN_SETTINGS_ACTION_ID } from '../../ribix/browser/ribixSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openVoid', comment: ['&& denotes a mnemonic'] }, "&&Open Ribix Settings"),
	},
	order: 1
});
