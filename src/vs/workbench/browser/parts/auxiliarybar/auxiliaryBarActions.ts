...
export class ToggleAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('toggleAuxiliaryBar', "Toggle Ribix Side Bar Visibility");
	...
	constructor() {
		super({
			...
			toggled: {
				...
				title: localize('closeSecondarySideBar', 'Hide Ribix Side Bar'),
				icon: closeIcon,
			...
			metadata: {
				description: localize('openAndCloseAuxiliaryBar', 'Open/Show and Close/Hide Ribix Side Bar'),
			},
			f1: true,
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('closeSecondarySideBar', 'Hide Ribix Side Bar'),
			category: Categories.View,
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('focusAuxiliaryBar', "Focus into Ribix Side Bar");
...
MenuRegistry.appendMenuItems([
	{
		...
		item: {
			...
			command: {
				id: ToggleAuxiliaryBarAction.ID,
				title: localize('toggleSecondarySideBar', "Toggle Ribix Side Bar"),
		...
		item: {
			...
			command: {
				id: ToggleAuxiliaryBarAction.ID,
				title: localize2('hideAuxiliaryBar', 'Hide Ribix Side Bar'),
			},
...
registerAction2(class extends SwitchCompositeViewAction {
	constructor() {
		super({
			...
			title: localize2('previousAuxiliaryBarView', 'Previous Ribix Side Bar View'),
			category: Categories.View,
			f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
	constructor() {
		super({
			...
			title: localize2('nextAuxiliaryBarView', 'Next Ribix Side Bar View'),
			category: Categories.View,
			f1: true
		}, ViewContainerLocation.AuxiliaryBar, 1);
	}
